 ...
 */
@RestController
@RequestMapping("ayangproduct/pmsspuinfodesc")
public class PmsSpuInfoDescController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ayangproduct:pmsspuinfodesc:list")
    ...
    //@RequiresPermissions("ayangproduct:pmsspuinfodesc:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ayangproduct:pmsspuinfodesc:save")
    ...
    //@RequiresPermissions("ayangproduct:pmsspuinfodesc:update")
    ...
    //@RequiresPermissions("ayangproduct:pmsspuinfodesc:delete")
