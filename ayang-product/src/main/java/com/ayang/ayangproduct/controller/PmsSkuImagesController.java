...
import com.ayang.ayangproduct.service.PmsSkuImagesService;
 ...
 */
@RestController
@RequestMapping("ayangproduct/pmsskuimages")
public class PmsSkuImagesController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ayangproduct:pmsskuimages:list")
    ...
    //@RequiresPermissions("ayangproduct:pmsskuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ayangproduct:pmsskuimages:save")
    ...
    //@RequiresPermissions("ayangproduct:pmsskuimages:update")
    ...
    //@RequiresPermissions("ayangproduct:pmsskuimages:delete")
