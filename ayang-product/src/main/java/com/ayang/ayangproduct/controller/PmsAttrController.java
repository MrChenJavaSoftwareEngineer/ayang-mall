...
import com.ayang.ayangproduct.service.PmsAttrService;
 ...
 */
@RestController
@RequestMapping("ayangproduct/pmsattr")
public class PmsAttrController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ayangproduct:pmsattr:list")
    ...
    //@RequiresPermissions("ayangproduct:pmsattr:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ayangproduct:pmsattr:save")
    ...
    //@RequiresPermissions("ayangproduct:pmsattr:update")
    ...
    //@RequiresPermissions("ayangproduct:pmsattr:delete")
