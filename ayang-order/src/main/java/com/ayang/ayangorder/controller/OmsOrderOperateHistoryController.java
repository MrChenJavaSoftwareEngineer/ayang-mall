...
import com.ayang.ayangorder.service.OmsOrderOperateHistoryService;
 ...
 */
@RestController
@RequestMapping("ayangorder/omsorderoperatehistory")
public class OmsOrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ayangorder:omsorderoperatehistory:list")
    ...
    //@RequiresPermissions("ayangorder:omsorderoperatehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ayangorder:omsorderoperatehistory:save")
    ...
    //@RequiresPermissions("ayangorder:omsorderoperatehistory:update")
    ...
    //@RequiresPermissions("ayangorder:omsorderoperatehistory:delete")
